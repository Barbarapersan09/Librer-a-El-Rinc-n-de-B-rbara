...
<body>
    ...
    <h1 class="my-5">Detalles</h1>
        <div class="row">
            <div class="col-lg-9 col-sm-9">
                <table class="table">
                    <tbody >
                        ...
                        <tr>
                            <th class="table-dark col-1" scope="col">Apellidos</th>
                        ...
                        <tr>
                            <th class="table-dark col-1" scope="col">DNI</th>
                            <td><?=$resultado["DNI"]?></td>
                        </tr>
                        <tr>
            ...
            <a href="../controlador/mainClienteControlador.php">Volver a página anterior.</a>
        </div>
